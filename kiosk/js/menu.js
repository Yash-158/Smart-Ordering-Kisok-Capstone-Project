...
function renderRecommendations(recs) {
  ...
  container.innerHTML = recs.map(rec => {
    const menuItem = window.menuItemsMap ? window.menuItemsMap[rec.item_id] : null;
    const imageUrl = menuItem && menuItem.image_url ? encodeURI(menuItem.image_url) 
                   : encodeURI('/public/images/' + rec.item_name + '.jpg');
    return `
